...
old_rep_ts_2 = 'error: (err: any) => { this.loading = false; this.messageService.add({severity:error, summary:Hata, detail:err.error?.detail || Kayıt sırasında hata oluştu}); }'
